export default function FAQ() {
  ...
  <div className="collapse collapse-arrow  bg-[rgb(165,216,255,0.3)] mb-3">
  ...
  <div className="collapse collapse-arrow bg-[rgb(165,216,255,0.3)] mb-3">
    ...
    <div className="collapse-title text-xl font-medium">Can I access courses on my mobile device?</div>
    <div className="collapse-content">
  ...
  <div className="collapse collapse-arrow bg-[rgb(165,216,255,0.3)]">
    <input type="radio" name="my-accordion-2" />
    <div className="collapse-title text-xl font-medium"> How do I become an instructor?</div>
    <div className="collapse-content">
