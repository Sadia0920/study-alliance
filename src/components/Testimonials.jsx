...
export default function Testimonials() {
  return (
    ...
    <div className="card bg-[rgb(212,208,229)] shadow-xl text-left">
      <div className="card-body">
      <h4 className="text-lg text-black font-bold">"The best online learning platform!"</h4>
      <h5 className="font-bold  text-black">Student Name - "John Doe"</h5>
      <p className="font-medium  text-black">"EduSphere helped me master AI fundamentals. The courses are engaging, and the instructors are highly knowledgeable. I landed my first internship thanks to this platform!"</p>
      </div>
      </div>
      <div className="card bg-[rgb(212,208,229)] shadow-xl text-left">
      <div className="card-body">
      ...
      <p className="font-medium text-black">"The ability to learn at my own pace with high-quality content is a game-changer. The premium courses are totally worth it!"</p>
  </div>
  </div>
  {/* 2 */}
