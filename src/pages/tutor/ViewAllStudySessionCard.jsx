...
const currentDate = new Date();
 ...
 const isOngoing = currentDate <= endDate;
  return (
    ...
    <p className="text-lg font-semibold text-black">Tutor Name: <span className="courseCard-description">{tutorName}</span></p>
    ...
    <p className="courseCard-header text-black">Status: <strong>{status}</strong></p>
